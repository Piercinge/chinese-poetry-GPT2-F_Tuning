...
# -----------------------------------------------------------------------------
DATA_CACHE_DIR = os.path.join(os.path.dirname(__file__), "tang")
...
def tokenize():
    data_filename = os.path.join(DATA_CACHE_DIR, "tang.txt")
    ...
    # save to file
    val_filename = os.path.join(DATA_CACHE_DIR, "tang_val.bin")
    train_filename = os.path.join(DATA_CACHE_DIR, "tang_train.bin")
